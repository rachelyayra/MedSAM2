...
from sam2.modeling.sam2_base_soft import SAM2Base
from sam2.modeling.sam2_utils import (
    get_1d_sine_pe,
    get_next_point,
    sample_box_points_softmax,
...
class SAM2Train(SAM2Base):
    def __init__(
        ...
        **kwargs,
        ...
        if freeze_all:
            ...
            for name, p in self.sam_mask_decoder.named_parameters():
    ...
    def prepare_prompt_inputs(self, backbone_out, input, start_frame_idx=0):
        ...
        for t in init_cond_frames:
            ...
            if not use_pt_input:
                ...
                if use_box_input:
                    points, labels = sample_box_points_softmax(
    ...
    def _iter_correct_pt_sampling(
        ...
        print(f'Groundtruth masks shape: {gt_masks.shape}')
        gt_masks =  gt_masks > 0  

        print(f'The groundtruth: {gt_masks.unique()}')
