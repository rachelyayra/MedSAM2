#!/bin/bash
#SBATCH --output=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_log/output_medtrain_tta.txt               # Standard error file
#SBATCH --error=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_log/error_medtrain_tta.txt               # Standard error file
#SBATCH --gres=gpu:4
