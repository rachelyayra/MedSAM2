#!/bin/bash
#SBATCH --output=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/batch_tta_medtrain.txt               # Standard error file
#SBATCH --error=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/batch_err_tta_medtrain.txt               # Standard error file
#SBATCH --gres=gpu:4
...
python /scratch_net/ken/radjoe/Projects/SourceCode/MedSAM2/training/train.py -c configs/batch_tta.yaml --use-cluster 0  --num-gpus 4
