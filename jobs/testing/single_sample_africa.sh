#!/bin/bash
#SBATCH --output=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/single_tta_africa_medtrain.txt               # Standard error file
#SBATCH --error=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/single_err_tta_africa_medtrain.txt               # Standard error file
...
python /scratch_net/ken/radjoe/Projects/SourceCode/MedSAM2/training/train.py -c configs/decoder_adapter.yaml --use-cluster 0  --num-gpus 1
