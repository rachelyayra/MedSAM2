#!/bin/bash
#SBATCH --output=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/val_tta_aug_output.txt               # Standard error file
#SBATCH --error=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/val_tta_aug_error.txt               # Standard error file
...
python /scratch_net/ken/radjoe/Projects/SourceCode/MedSAM2/training/train.py -c configs/test_time_adaptation_augs.yaml --use-cluster 0  --num-gpus 1
