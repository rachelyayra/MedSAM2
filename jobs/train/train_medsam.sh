#!/bin/bash
#SBATCH --output=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/output_multi_medtrain.txt               # Standard error file
#SBATCH --error=/scratch_net/ken/radjoe/Projects/Experiments/SAMEXP/output_logs/error_multi_medtrain.txt               # Standard error file
...
python /scratch_net/ken/radjoe/Projects/Experiments/MedSAM2/training/train.py -c configs/finetuning_BraTS.yaml --use-cluster 0  --num-gpus 1
